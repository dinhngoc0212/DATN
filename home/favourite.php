<?php
    session_start();
    include("../connect.php");
    $values_list = array_values((array)$_SESSION['favourite_products']);
    $values_csv = implode(',', $values_list);
    ...
    WHERE product.status = 1 AND sub_category.status = 1 AND product.ID IN ($values_csv) "; 
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row ">
                ...
                <div class="col m-3" >
                    <div class="home-title d-flex justify-content-between">
                        <a href="category.php" class="text-dark pt-2"><b>Sản phầm yêu thích</b></a>
...
<script>
    document.getElementById('hidden-filter-form').setAttribute('hidden','');
</script>